...
@Component({
  ...
  animations: [
    trigger('slideInOut', [
      state('floorin', style({ transform: 'translate(0)',background: 'rgb(228 226 226)', width:'82.5vw',height: '76vh',position: 'relative',top: '-19.6rem', 'border-radius':' 15px ','z-index':1,left:'-1.3rem'})),
    ...
    trigger('dataInOut', [
      ...
      state('out', style({ transform: 'translate(0,0)',display:'none', width:'0rem', height:'0rem',position: 'relative',top: '-54.6rem',left:'-1rem',  })),
